...
/**
 * Implement an scraper for Office documents.
 * @author ealdana@tamps.cinvestav.mx
 */
public class OFFICEScraper implements IScraper {
           ...
           try {
              ...
              Logger.getLogger(GoogleResourcesFinder.class.getName()).log(Level.FINE, "The resource:{0}\n was obtained",url);                
                 ...
                 {  if(e instanceof IOException ) { 
                        ...
                        doc.setSource(new URL(url));
                        doc.setRecoveringDate(new Date());
                        Logger.getLogger(OFFICEScraper.class.getName()).log(Level.WARNING, msg,e);
                    }
                 }
                ...
                if (is != null) is.close();
                Logger.getLogger(OFFICEScraper.class.getName()).log(Level.FINE, "The stream was closed");                
            }
            return doc;
